...
namespace AdaptiveCards { namespace XamlCardRenderer
{
    ...
    public:
        ...
        // IAdaptiveSeparator
        IFACEMETHODIMP get_Color(_Out_ ABI::AdaptiveCards::XamlCardRenderer::SeparatorColor* color);
        IFACEMETHODIMP put_Color(_In_ ABI::AdaptiveCards::XamlCardRenderer::SeparatorColor color);
