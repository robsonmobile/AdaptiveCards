...
namespace AdaptiveCards { namespace XamlCardRenderer
{
    ...
    _Use_decl_annotations_
    HRESULT AdaptiveSeparator::get_Color(ABI::AdaptiveCards::XamlCardRenderer::SeparatorColor* color)
    {
        *color = static_cast<ABI::AdaptiveCards::XamlCardRenderer::SeparatorColor>(m_sharedSeparator->GetColor());
        return S_OK;
    }

    _Use_decl_annotations_
    HRESULT AdaptiveSeparator::put_Color(ABI::AdaptiveCards::XamlCardRenderer::SeparatorColor color)
    {
        m_sharedSeparator->SetColor(static_cast<AdaptiveCards::SeparatorColor>(color));
        return S_OK;
    }
